 ...
 * Template Name: Homenew Template
...
<style>
    ...
    #carousel .slide_lift_img img{ width: 100%;}
    #carousel .slide_lift_img{ width: 100%;}
    .carousel-control-prev i, .carousel-control-next i {

  box-shadow: 0px 0px 5px rgab(0,0,0,0.2) !important;
                ...
                <div class="d-flex flex-row justify-content-center flex-wrap pb-5">
                    ...
                    <div class="row justify-content-center">
                        ...
                        <div class="col-sm-5 col-12">
                            <div class="img">
                                <a href="<?php echo site_url('write-a-story'); ?>"> <img src="<?php echo get_template_directory_uri(); ?>/assets/RegisgterOnline-01.jpeg" alt="img" class="img-fluid" />
                                </a>
                            </div>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-sm-5 col-12 pl-5 ho">
                ...
                <p>Subscribe our club will be the best experience of your life! You will become a worldwide writer and storyteller.</p>
                <p> <a href="<?php echo (!is_user_logged_in()) ? site_url('subscribe') : site_url('subscribe'); ?>" class="btn btn-secondary white_button">Subscribe Now</a></p>
