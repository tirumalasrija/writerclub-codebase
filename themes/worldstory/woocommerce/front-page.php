...
<!--explaining purpose of website-->
 <!--explaining purpose of website-->
    ...
    <div class="slider_bg pb-5">
        <h4 class="text-center mb-4 pt-5">Today's Picture Book</h4>
        <div class="container">
            <section id="carousel">
                        ...
                        <div class="carousel-item">
                            <div class="row align-items-center justify-content-center">
                                <div class="col-md-6 slide_img">
                                    <div class="slide_lift_img d-inline-block"><img src="assets/slide1.png"></div>
                                </div>
                                <div class="col-md-6 slide_content">
                                    <div>
                                        <div class="card p-3">
                                            <h5>Two Friends &amp; The Bear</h5>
                                            ...
                                            <p>Vijay thought for a second. He’d heard animals don’t prefer dead bodies, so he fell to the ground and held his breath. The bear sniffed him and thought he was dead. So, it went on its way. Vijay and Raju were
                                                friends. On a holiday they went walking into a forest, enjoying the beauty of nature. Suddenly they saw a bear coming at them. They became frightened.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
