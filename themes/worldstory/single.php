        ...
        <div  class="d-flex flex-column col-lg-12">
                ...
                <div  class="share_story mt-3">
                    <b  class="story_feed d-flex">
                        <a  href="<?php echo site_url('story-feed'); ?>"><i  class="fas fa-arrow-left"></i></a>&nbsp;<?php the_title( '<h3 class="entry-title"><a href="' . esc_url( get_permalink() ) . '" rel="bookmark">', '</a></h3>' ); ?>
                    </b>
                </div>
            <div  class="w-100">
                <?php 
            ...
            <div  class="d-flex justify-content-between align-items-center mt-3 mb-5">
                ...
                <div >
                    <div  class="d-flex justify-content-between align-items-center">
                        <div  class="share"><a href="<?php echo site_url('share-story'); ?>?share=<?php echo get_the_ID(); ?>"><i  class="fas fa-share-alt"></i></a></div>
                        <div class="ml-1">Share Story</div>
                    </div>
                </div>
            </div>
        </div>
