...
SV_WC_Framework_Bootstrap::instance()->register_plugin( '4.7.2', __( 'WooCommerce Memberships', 'woocommerce-memberships' ), __FILE__, 'init_woocommerce_memberships', array(
