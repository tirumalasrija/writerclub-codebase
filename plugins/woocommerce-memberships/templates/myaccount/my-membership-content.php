		...
		<thead>
			<tr>
				...
				$my_membership_content_columns = (array) apply_filters( 'wc_memberships_members_area_my_membership_content_column_names', array(
					'membership-content-title'      => wc_memberships_get_members_area_sorting_link( 'title', __( 'Title', 'woocommerce-memberships' ) ),
					'membership-content-type'       => wc_memberships_get_members_area_sorting_link( 'type', __( 'Type', 'woocommerce-memberships' ) ),
