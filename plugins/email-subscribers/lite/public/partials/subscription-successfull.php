...
?>
    <html>
      <head>
            <link href="https://unpkg.com/tailwindcss@^1.5.1/dist/tailwind.min.css" rel="stylesheet">
              ...
              <div class="flex">
                <div class="sm:w-1/3 xl:w-1/4 pl-6 leading-6">
                  <p class="uppercase text-sm text-gray-600 pl-2 pb-2 tracking-wide">
                    <?php _e('Powered by','email-subscribers'); ?>
                  </p>
                ...
                <div class="pl-8 pr-6 text-gray-700">
                    <p class="pb-2 text-base font-bold text-gray-700">
                       <?php _e('Want to Engage, Inspire and Convert Your Website Visitors ?','email-subscribers'); ?>
                    </p>
                    <p class="text-sm text-gray-700">
                       <?php _e('The most loved WordPress plugins for lead capture, call to action and email marketing.','email-subscribers'); ?>
                       <a class="text-sm font-medium text-indigo-600 hover:text-indigo-500" href="https://www.icegram.com/">
                           <?php _e(' Take a look here','email-subscribers'); ?> 
